    ...
    <>
      ...
      <div className="px-20 md:px-1">
        <Header color="text-black" filter="brightness-0 saturate-100">
          ...
          <a href="https://discord.gg/CZQC" rel="noopener noreferrer" className="hover:-translate-y-1 transition-all text-gray-900" target="_blank">
            Discord
          </a>
          <a href="https://www.patreon.com/CZQC" rel="noopener noreferrer" className="hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-600/40 transition-all bg-blue-600 px-3 py-2 text-white rounded">
            Whitelist
          </a>
        </Header>
      </div>
